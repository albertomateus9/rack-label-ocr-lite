...
Local-first rack and patch-panel label extractor using browser text detection when available.

## Overview

Rack Label OCR Lite is a browser-first MVP for the GitHub portfolio of Alberto Mateus P. da Gama. It is built to demonstrate low-cost computer vision applied to telecommunications, infrastructure operations, and technical education.
...
Rack Label OCR Lite e um MVP browser-first para o portfolio GitHub de Alberto Mateus P. da Gama. O projeto demonstra visao computacional de baixo custo aplicada a telecomunicacoes, operacoes de infraestrutura e educacao tecnica.
